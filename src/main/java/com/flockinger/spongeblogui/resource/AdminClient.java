...
public interface AdminClient {
	...
	PostsPageDTO getPosts(@RequestParam(required=false,defaultValue=PAGING_DEFAULT_PAGE_KEY, value = PAGE_PARAM_NAME) Integer page, 
	...
	PostsPageDTO getPostsByUserAndStatus(@PathVariable("userId") Long userId, @PathVariable("status") String status, 
			@RequestParam(required=false,defaultValue=PAGING_DEFAULT_PAGE_KEY, value = PAGE_PARAM_NAME) Integer page, 
			@RequestParam(required=false,defaultValue=PAGING_DEFAULT_ITEMS_PER_PAGE_KEY, value = SIZE_PARAM_NAME) Integer size);
	...
	PostsPageDTO getPostsByCategoryAndStatus(@PathVariable("categoryId") Long categoryId, @PathVariable("status") String status, 
			@RequestParam(required=false,defaultValue=PAGING_DEFAULT_PAGE_KEY, value = PAGE_PARAM_NAME) Integer page, 
			@RequestParam(required=false,defaultValue=PAGING_DEFAULT_ITEMS_PER_PAGE_KEY, value = SIZE_PARAM_NAME) Integer size);
	...
	PostsPageDTO getPostsByTagAndStatus(@PathVariable("tagId") Long tagId, @PathVariable("status") String status, 
			@RequestParam(required=false,defaultValue=PAGING_DEFAULT_PAGE_KEY, value = PAGE_PARAM_NAME) Integer page, 
			@RequestParam(required=false,defaultValue=PAGING_DEFAULT_ITEMS_PER_PAGE_KEY, value = SIZE_PARAM_NAME) Integer size);
}
