...
public class AdminServiceImpl implements AdminService {
  ...
  private PostsPageDTO getPostsByUser(Long userId, PostStatus status, Paging page) {
    ...
    return client.getPostsByUserAndStatus(userId, status.toString(), page.getPage(),
        page.getSize());
  }
  ...
  private PostsPageDTO getPostsByCategory(Long categoryId, PostStatus status, Paging page) {
    ...
    return client.getPostsByCategoryAndStatus(categoryId, status.toString(), page.getPage(),
        page.getSize());
  }
