...
public class AdminServiceSimpleTest {
	...
	public void testGetAllPosts_withCorrectPaging_shouldPushCorrect() throws Exception { 
		...
		PostsPageDTO result = service.getAllPosts(new Paging(Optional.of(1), 6, ""));
	...
	public void testGetAllPosts_withEmptyPaging_shouldPushCorrect() throws Exception { 
		...
		PostsPageDTO result = service.getAllPosts(new Paging(Optional.empty(), 6, ""));
	...
	public void testGetPostsByStatus_withCorrectPaging_shouldPushCorrect() throws Exception {
		...
		PostsPageDTO posts = new PostsPageDTO();
		when(client.getPostsByStatus(catchStatus.capture(),catchPage.capture(), catchSize.capture())).thenReturn(posts);
		
		PostsPageDTO result = service.getPostsByStatus(PostStatus.PUBLIC,new Paging(Optional.of(3), 4, ""));
	...
	public void testGetPostsByUser_withPublicStatus_shouldPushCorrectApiCall() throws Exception {
		...
		PostsPageDTO posts = new PostsPageDTO();
		when(client.getPostsByUserAndStatus(catchUser.capture(),catchStatus.capture(),catchPage.capture(), catchSize.capture())).thenReturn(posts);
		
		PostsPageDTO result = service.getPostsByUser(34l,PostStatus.PUBLIC,new Paging(Optional.of(3), 4, ""));
		...
		verify(client,times(1)).getPostsByUserAndStatus(anyLong(),matches(PostStatus.PUBLIC.toString()),anyInt(), anyInt());
	}
	...
	public void testGetPostsByUser_withAllStatus_shouldPushCorrectApiCall() throws Exception {
		...
		PostsPageDTO result = service.getPostsByUser(34l,PostStatus.ALL,new Paging(Optional.of(3), 4, ""));
	...
	public void testGetPostsByTag_withPublicStatus_shouldPushCorrectApiCall() throws Exception {
		...
		PostsPageDTO posts = new PostsPageDTO();
		when(client.getPostsByTagAndStatus(catchTag.capture(),catchStatus.capture(),catchPage.capture(), catchSize.capture())).thenReturn(posts);
		
		PostsPageDTO result = service.getPostsByTag(34l,PostStatus.PUBLIC,new Paging(Optional.of(3), 4, ""));
		...
		verify(client,times(1)).getPostsByTagAndStatus(anyLong(),matches(PostStatus.PUBLIC.toString()),anyInt(), anyInt());
	}
	...
	public void testGetPostsByTag_withAllStatus_shouldPushCorrectApiCall() throws Exception {
		...
		PostsPageDTO result = service.getPostsByTag(34l,PostStatus.ALL,new Paging(Optional.of(3), 4, ""));
	...
	public void testGetPostsByCategory_withPublicStatus_shouldPushCorrectApiCall() throws Exception {
		...
		PostsPageDTO posts = new PostsPageDTO();
		when(client.getPostsByCategoryAndStatus(catchCategory.capture(),catchStatus.capture(),catchPage.capture(), catchSize.capture())).thenReturn(posts);
		
		PostsPageDTO result = service.getPostsByCategory(34l,PostStatus.PUBLIC,new Paging(Optional.of(3), 4, ""));
		...
		verify(client,times(1)).getPostsByCategoryAndStatus(anyLong(),matches(PostStatus.PUBLIC.toString()),anyInt(), anyInt());
	}
	...
	public void testGetPostsByCategory_withAllStatus_shouldPushCorrectApiCall() throws Exception {
		...
		ArgumentCaptor<Long> catchCategory = ArgumentCaptor.forClass(Long.class);
		PostsPageDTO posts = new PostsPageDTO();
		when(client.getPostsByCategory(catchCategory.capture(),catchPage.capture(), catchSize.capture())).thenReturn(posts);
		
		PostsPageDTO result = service.getPostsByCategory(34l,PostStatus.ALL,new Paging(Optional.of(3), 4, ""));
